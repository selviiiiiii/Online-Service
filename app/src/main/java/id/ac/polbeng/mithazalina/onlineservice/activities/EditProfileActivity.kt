...
import id.ac.polbeng.mithazalina.onlineservice.databinding.ActivityEditProfileBinding
...
class EditProfileActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnSubmit.setOnClickListener {
            ...
            if (TextUtils.isEmpty(password) && TextUtils.isEmpty(konfirmasiPassword)) { password = ""
            } else {
                ...
                override fun onResponse(
                    ...
                    if(!response.body()?.error!!) {
                        ...
                        defaultResponse.let {
                            ...
                            Toast.makeText(this@EditProfileActivity, defaultResponse.message, Toast.LENGTH_LONG).show()
                            finish()
                        }
                    }else{
